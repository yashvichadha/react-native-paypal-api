...
const data = {};
export const Paypal = /*#__PURE__*/createContext(data);
export const PaypalProvider = ({
  ...
  return /*#__PURE__*/React.createElement(Paypal.Provider, {
    value: PaypalContext
  }, children, /*#__PURE__*/React.createElement(PaymentModal, null));
};
